...
const SeenPage = () => {
    ...
    return (
        <div>
            {contextHolder}
            <div
                style={{ margin: "0px 15vw", flex: 1 }}
            //  style={isWide ? { margin: "0px 50px", flex: 1 } : isVeryWide ? { margin: "0px 10vw", flex: 1 } : { margin: "0px 15vw", flex: 1 }}
            >
                <h1 style={{ marginTop: "100px" }}>Seen Page</h1>
                <p>This is the Seen page content.</p>
